<template>
  <Bloc class="photo" :style="{'background-image': 'url(' + photo.urls.regular + '?utm_source=d6b82f23cda09babcf74c2b38e342b3f246be679e7b5a55f642b552ff55d9bdf&utm_medium=referral)' }">
