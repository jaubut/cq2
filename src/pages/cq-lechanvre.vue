<template>
  <div id="LeChanvre">
    <template v-if="$store.state.lang.lang === 'fr-CA'">
      ...
      <Bloc class="height-normal" style="background-image: url(../../static/lechanvre/paul.jpg);"></Bloc>
      <Bloc class="height-normal" style="background-image: url(../../static/lechanvre/chanvrons.jpg);"></Bloc>
