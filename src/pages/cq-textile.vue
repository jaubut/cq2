<template>
  <div id="textile">
    ...
    <Bloc class="height-normal">
      <Texte>
        <h2>Pourquoi se vêtir en chanvre? </h2>
    ...
    <Bloc class="height-normal" style="background-image: url(../../static/textile/samjeremy2.jpg);" > </Bloc>
    <Bloc class="height-normal" style="background-image: url(../../static/textile/textile.jpg);" > </Bloc>
    ...
    <Bloc class="height-normal" style="background-image: url(../../static/textile/shinto.jpg);" > </Bloc>
    <Bloc class="height-normal" style="background-image: url(../../static/textile/adidas.jpg);" > </Bloc>
    <Bloc class="height-normal">
      <Texte>
        <p>En raison de l’essor de l’industrie du coton et de la prohibition (injustifié) de la plante de chanvre en Amérique du Nord, l’industrie a connu un important recul. Aujourd’hui, son utilisation est en pleine émergence, avec des joueurs comme <strong>Adidas</strong> et Patagonia qui l’utilisent dans leurs créations. </p>
      </Texte>
    </Bloc>
  </div>
</template>
